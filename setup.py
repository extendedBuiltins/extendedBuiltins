...
def write_version_py(filename='extendedBuiltins/version.py'):
...
def setup_package():
    ...
    setup(
        ...
        project_urls={
            ...
            'Bug Tracker': 'https://github.com/extendedBuiltins/extendedBuiltins/issues',
        },

        author='Romain J.',
        author_email='romain.ordi@gmail.com',
        maintainer='Romain J.',
        maintainer_email='romain.ordi@gmail.com',
